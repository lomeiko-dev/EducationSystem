...
namespace EducationSystem.Helper.Custom
{
    public class CustomIdentityErrorDescription : IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateEmail(string email) { return new IdentityError { Code = nameof(DuplicateEmail), Description = $"Адрес {email} уже зарегстрирован на сайте" }; }
