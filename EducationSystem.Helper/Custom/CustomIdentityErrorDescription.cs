...
namespace EducationSystem.Helper.Custom
{
    public class CustomIdentityErrorDescription : IdentityErrorDescriber
    {
        ...
        public override IdentityError InvalidToken() { return new IdentityError { Code = nameof(InvalidToken), Description = "Невалдиный токен" }; }
        ...
        public override IdentityError InvalidEmail(string email) { return new IdentityError { Code = nameof(InvalidEmail), Description = "Такой email уже существует." }; }
